...
import { Moon, Sun, Laptop, Bell, Palette, Shield, ChevronLeft, Building } from 'lucide-react';
import {
  Select,
  SelectContent,
  SelectItem,
...
export default function SettingsClientPage() {
  ...
  if (!mounted) {
    // return null or a loading skeleton to avoid hydration error
    return null;
  }
    ...
    <div className="container mx-auto py-8 space-y-8 max-w-4xl">
      <div>
        ...
        <p className="text-muted-foreground">
          Manage your organization's settings, notifications, and appearance.
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Choose how you and your team want to be notified.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="flex items-center justify-between rounded-lg border p-4">
            <div>
              <Label htmlFor="new-applicant" className="font-medium">
                New Applicant Submissions
              </Label>
              <p className="text-sm text-muted-foreground">
                Receive an email when a student applies to one of your internships.
              </p>
            </div>
          ...
          <div className="flex items-center justify-between rounded-lg border p-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Get notified when a student provides feedback on an internship or course.
              </p>
            </div>
            <Switch id="feedback-updates" defaultChecked />
          </div>
        </CardContent>
        <CardFooter>
        ...
        <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                        Edit your organization's public profile and information.
                    </p>
                </div>
                <Button variant="outline" asChild>
                  <Link href="/host/profile">
                    <Building className="mr-2 h-4 w-4"/> Edit Profile
                  </Link>
                </Button>
            </div>
             <Separator />
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Permanently delete your account and all of your organization's data.
              </p>
            </div>
            <Dialog>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    ...
                    your account and remove your organization's data from our servers.
                  </DialogDescription>
                </DialogHeader>
